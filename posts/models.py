...
class Post(models.Model):
    titulo_post = models.CharField(max_length=225, verbose_name='Título')
    ...
    categoria_post =  models.ForeignKey(Categoria, on_delete=models.DO_NOTHING,
     blank=True,null=True, verbose_name='Categoria') # Não é requerida
    imagem_post = models.ImageField(upload_to=r'post_img/%Y/%m/%d', blank=True, verbose_name='Imagem')
